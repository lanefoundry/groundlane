...
- [x] 現有 URL/raw-HTML `parse` flat schema 保持相容；新 document tool 使用 canonical envelope。任何 convergence 只透過 additive/versioned fields 並通過既有 schema snapshot、tool list、HTML fixtures 與 Claude/Codex/Cursor compatibility tests。
